...
requests, discussions, commit history) and when an individual is
officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may
be reported to the project maintainers via a GitHub issue (or, when
sensitive, by direct message). All complaints will be reviewed and
